...
export default function PrintDigitalCert({ valuation }) {
  ...
  return (
    <div>
      {/* Main certificate — uses table structure so header/footer repeat on each printed page */}
      <table className="dc-page-table">
        <thead>
          <tr><td>
      ...
      {/* KYC Documents page — always last, no changes */}
