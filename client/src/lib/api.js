...
export const api = {
  ...
  auth: {
    ...
    requestOtp: (data) => request('/auth/request-otp', { method: 'POST', body: data }),
    ...
    approveUser: (id) => request(`/auth/users/${id}/approve`, { method: 'POST' }),
    rejectUser: (id) => request(`/auth/users/${id}/reject`, { method: 'POST' }),
