...
export const useValuationStore = create((set, get) => ({
  ...
  hydrate: (valuation) => set({
    form: deriveForm({
      ...
      goldLoanRegisterNo: valuation.goldLoanRegisterNo || '',
      goldPacketsNo: valuation.goldPacketsNo || '',
      renewalDate: valuation.renewalDate || '',
      tenureMonths: valuation.tenureMonths ?? '',
      empanelmentId: valuation.empanelmentId || '',
  ...
  payload: () => {
    ...
    return {
      ...
      goldLoanRegisterNo: form.goldLoanRegisterNo,
      goldPacketsNo: form.goldPacketsNo,
      renewalDate: form.renewalDate || null,
      tenureMonths: form.tenureMonths === '' || form.tenureMonths == null ? null : Number(form.tenureMonths),
      empanelmentId: form.empanelmentId,
