...
for (const stmt of [
  ...
  'ALTER TABLE bank_presets ADD COLUMN empanelment_id TEXT',
  ...
  'ALTER TABLE appraiser_profile ADD COLUMN bank_account_number TEXT',
  'ALTER TABLE customers ADD COLUMN current_address TEXT',
  'ALTER TABLE customers ADD COLUMN current_address_different INTEGER NOT NULL DEFAULT 0',
